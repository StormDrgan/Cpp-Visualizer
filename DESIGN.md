...
v0.4 ✅ 数组可视化 + 断点    v0.8 ✅ 可视化目标勾选 + 即时过滤（标注降级为兜底）
                            ...
                            v0.10 🚧 Level 2 实现中（B树/B+树已完成，其余规划中）
```
...
预设模板 24 个，按 6 大分类组织，通过顶部 Header 的分类卡片弹窗选择（支持搜索过滤）：
...
> **文档版本**：v0.10
> **最后更新**：2026-06-22
> **状态**：v0.9 UI 重构 + @viz 交互 + Level 1 全覆盖 + 统一样式已完成；v0.10 B树/B+树实现中，其余 Level 2 已规划
